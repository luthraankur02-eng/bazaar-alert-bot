...
STOCKS = {
    ...
    "TITAN.NS":      {"name": "Titan Company",         "aliases": ["titan","tanishq","titan company"],                  "sector": "Consumer"},
    "JBMA.NS":       {"name": "JBM Auto",              "aliases": ["jbm","jbm auto"],                                  "sector": "Auto"},
    "CONCOR.NS":     {"name": "Container Corporation", "aliases": ["concor","container corporation","concorindia"],     "sector": "Logistics"},
    "ASIANPAINT.NS": {"name": "Asian Paints",          "aliases": ["asian paints","asian paint"],                      "sector": "Paints"},
    "BAJAJFINSV.NS": {"name": "Bajaj Finserv",         "aliases": ["bajaj finserv","bajajfinsv"],                      "sector": "Finance"},
    "HAVELLS.NS":    {"name": "Havells",               "aliases": ["havells"],                                         "sector": "Consumer"},
    "TRENT.NS":      {"name": "Trent",                 "aliases": ["trent","westside","zudio"],                        "sector": "Retail"},
    "MUTHOOTFIN.NS": {"name": "Muthoot Finance",       "aliases": ["muthoot","muthoot finance"],                       "sector": "Finance"},
    "TORNTPHARM.NS": {"name": "Torrent Pharma",        "aliases": ["torrent","torrent pharma"],                        "sector": "Pharma"},
    "LUPIN.NS":      {"name": "Lupin",                 "aliases": ["lupin"],                                           "sector": "Pharma"},
    "AUROPHARMA.NS": {"name": "Aurobindo Pharma",      "aliases": ["aurobindo","auro pharma"],                         "sector": "Pharma"},
    "SIEMENS.NS":    {"name": "Siemens",               "aliases": ["siemens"],                                         "sector": "Capital Goods"},
    "ABB.NS":        {"name": "ABB India",             "aliases": ["abb","abb india"],                                  "sector": "Capital Goods"},
    "BHARATFORG.NS": {"name": "Bharat Forge",          "aliases": ["bharat forge","bharatforge"],                      "sector": "Auto"},
    "MRF.NS":        {"name": "MRF",                   "aliases": ["mrf","madras rubber"],                             "sector": "Auto"},
    "PERSISTENT.NS": {"name": "Persistent Systems",    "aliases": ["persistent","persistent systems"],                  "sector": "IT"},
    "COFORGE.NS":    {"name": "Coforge",               "aliases": ["coforge","niit technologies"],                     "sector": "IT"},
    "LTIM.NS":       {"name": "LTIMindtree",           "aliases": ["ltimindtree","ltim","mindtree"],                   "sector": "IT"},
    "MPHASIS.NS":    {"name": "Mphasis",               "aliases": ["mphasis"],                                         "sector": "IT"},
    "NAUKRI.NS":     {"name": "Info Edge",             "aliases": ["naukri","infoedge","info edge"],                   "sector": "Tech"},
...
NSE_SYMBOL_TOKENS = {
    ...
    "ASIANPAINT.NS":  {"token": "236",    "symbol": "ASIANPAINT-EQ"},
    "BAJAJFINSV.NS":  {"token": "16675",  "symbol": "BAJAJFINSV-EQ"},
    "PIDILITIND.NS":  {"token": "2664",   "symbol": "PIDILITIND-EQ"},
    "HAVELLS.NS":     {"token": "430",    "symbol": "HAVELLS-EQ"},
    "VOLTAS.NS":      {"token": "3718",   "symbol": "VOLTAS-EQ"},
    "TRENT.NS":       {"token": "1964",   "symbol": "TRENT-EQ"},
    "PAGEIND.NS":     {"token": "14413",  "symbol": "PAGEIND-EQ"},
    "MUTHOOTFIN.NS":  {"token": "3893",   "symbol": "MUTHOOTFIN-EQ"},
    "CHOLAFIN.NS":    {"token": "685",    "symbol": "CHOLAFIN-EQ"},
    "SHRIRAMFIN.NS":  {"token": "4306",   "symbol": "SHRIRAMFIN-EQ"},
    "TORNTPHARM.NS":  {"token": "500",    "symbol": "TORNTPHARM-EQ"},
    "ALKEM.NS":       {"token": "8522",   "symbol": "ALKEM-EQ"},
    "AUROPHARMA.NS":  {"token": "275",    "symbol": "AUROPHARMA-EQ"},
    "LUPIN.NS":       {"token": "10440",  "symbol": "LUPIN-EQ"},
    "ABBOTINDIA.NS":  {"token": "4",      "symbol": "ABBOTINDIA-EQ"},
    "SIEMENS.NS":     {"token": "3200",   "symbol": "SIEMENS-EQ"},
    "ABB.NS":         {"token": "13",     "symbol": "ABB-EQ"},
    "BOSCHLTD.NS":    {"token": "2181",   "symbol": "BOSCHLTD-EQ"},
    "CUMMINSIND.NS":  {"token": "1901",   "symbol": "CUMMINSIND-EQ"},
    "BHARATFORG.NS":  {"token": "422",    "symbol": "BHARATFORG-EQ"},
    "MOTHERSON.NS":   {"token": "4204",   "symbol": "MOTHERSON-EQ"},
    "BALKRISIND.NS":  {"token": "335",    "symbol": "BALKRISIND-EQ"},
    "MRF.NS":         {"token": "2277",   "symbol": "MRF-EQ"},
    "APOLLOTYRE.NS":  {"token": "163",    "symbol": "APOLLOTYRE-EQ"},
    "EXIDEIND.NS":    {"token": "1616",   "symbol": "EXIDEIND-EQ"},
    "PERSISTENT.NS":  {"token": "18365",  "symbol": "PERSISTENT-EQ"},
    "COFORGE.NS":     {"token": "13611",  "symbol": "COFORGE-EQ"},
    "LTIM.NS":        {"token": "17818",  "symbol": "LTIM-EQ"},
    "MPHASIS.NS":     {"token": "4503",   "symbol": "MPHASIS-EQ"},
    "OFSS.NS":        {"token": "10738",  "symbol": "OFSS-EQ"},
    "NAUKRI.NS":      {"token": "13751",  "symbol": "NAUKRI-EQ"},
    "POLICYBZR.NS":   {"token": "543390", "symbol": "POLICYBZR-EQ"},
    "PAYTM.NS":       {"token": "543396", "symbol": "PAYTM-EQ"},
}
